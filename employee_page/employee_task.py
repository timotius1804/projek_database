...
def task_display(root: Tk, cursor, data, name, user_id):
    ...
    label_task_name_value = Label(task_window, text=f"{data}", font=("Arial", 14), bg="white")
    ...
    label_due_date_value = Label(task_window, text=due_date_text, font=("Arial", 14), bg="white")
