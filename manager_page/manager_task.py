...
welcome_label = Label(root, text=f"Tasks for {project_name}")
...
Mark_button = Button(frame_two, text="Delete Task", width=int(screen_width - screen_width * 0.96484375),  height=2, font=('Inter', 14))
