...
tree.column("ID", anchor="center", width=screen_width-1230)
tree.column("Task Name", anchor="w", width=screen_width-880)
tree.column("Due Date", anchor="w", width=screen_width-1180)
tree.column("Status", anchor="center", width=screen_width-1180)
...
View_details_button = Button(frame_two, text="View details", width=screen_width-1235, height=2, font=('Inter', 14))
View_details_button.grid(row=0, column=0, sticky="e", pady=10, padx=5)

# Mengatur tombol "Mark as Done / Not Done"
Mark_button = Button(frame_two, text="Mark as Done /\nNot Done", width=screen_width-1234, height=2, font=('Inter', 14))
...
Logout_button = Button(frame_two, text="Logout", width=screen_width-1273, height=1, font=('Inter'))
