...
def frame_2(root,mycursor,user_name,user_id):
    ...
    name = user_name  # Ganti dengan nama pengguna yang sesuai
    status = "Employee"
    ...
    tree.column("Task Name", anchor="w", width=400)
    tree.column("Due Date", anchor="w", width=100)
    ...
    View_details_button = Button(frame_two, text="View details", width=45, height=2, font=('Inter', 14))
    View_details_button.grid(row=0, column=0, sticky="e", pady=10, padx=5)

    # Mengatur tombol "Mark as Done / Not Done"
    Mark_button = Button(frame_two, text="Mark as Done /\nNot Done", width=45, height=2, font=('Inter', 14), command=mark_done_button)
    Mark_button.grid(row=1, column=0, sticky="e", pady=10, padx=5)

    del_button = Button(frame_two, text="Delete", width=45, height=2, font=('Inter', 14), command=delete_button)
    del_button.grid(row=2, column=0, sticky="e", pady=10, padx=5)
